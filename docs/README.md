...
| [13-sprint3a-avance.md](./13-sprint3a-avance.md) | Bitácora: avance del Sprint 3a (auth + listas) en curso — carril A (7/8 tareas) y carril B (3/5), cambio de contrato `field?: string`, bug de accesibilidad en `ChecklistTree`, hallazgos de la revisión pre-merge, seed de listas en Odoo local (B2) y endpoints `/me/*` de lectura (B3) |
...
- [ ] Sprint 3a — auth + estructura de listas (camino crítico actual). Diseñado y replanificado el 2026-08-31: ver [12-diseno-sprint3a.md](./12-diseno-sprint3a.md) y **ADR-014 a ADR-019** (aislamiento de datos privados, identidad, transporte de sesión/CSRF, MSW vs. backend en paralelo, recálculo de `aggregatedProgress`, uso de `sudo()` en `/me/*`). En curso al 2026-09-08: carril A 7/8 tareas (3.1, 3.2, 3.3a, 3.4, 3.5a, 3.5b ✅; faltan 3.5c, 3.6), carril B 3/5 (B1, B2, B3 ✅; faltan B4, B5) — ver [13-sprint3a-avance.md](./13-sprint3a-avance.md)
