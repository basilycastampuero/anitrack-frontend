...
| [13-sprint3a-avance.md](./13-sprint3a-avance.md) | Bitácora: avance del Sprint 3a (auth + listas) en curso — carril A (6/8 tareas) y carril B (1/5), cambio de contrato `field?: string`, bug de accesibilidad en `ChecklistTree`, hallazgos de la revisión pre-merge y deuda abierta |
...
- [ ] Sprint 3a — auth + estructura de listas (camino crítico actual). Diseñado y replanificado el 2026-08-31: ver [12-diseno-sprint3a.md](./12-diseno-sprint3a.md) y **ADR-014 a ADR-017** (aislamiento de datos privados, identidad, transporte de sesión/CSRF, MSW vs. backend en paralelo). En curso al 2026-09-03: carril A 6/8 tareas (3.1, 3.2, 3.3a, 3.4, 3.5a ✅; faltan 3.5b, 3.5c, 3.6), carril B 1/5 (B1 ✅; faltan B2–B5) — ver [13-sprint3a-avance.md](./13-sprint3a-avance.md)
